<div id="slider" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img src="{{asset('recursos/img/slider/bayusa_slider1.png')}}" class="img-responsive" alt="Bayusa Productos">
          ...
          <div class="item">
            <img src="{{asset('recursos/img/slider/bayusa_slider2.png')}}" class="img-responsive" alt="Bayusa Productos">
            <!--div class="carousel-caption">
          ...
          <div class="item">
            <img src="{{asset('recursos/img/slider/bayusa_slider3.png')}}" class="img-responsive" alt="Bayusa Productos">
            <div class="carousel-caption">
              <h2></h2>
          ...
          <div class="item">
            <img src="{{asset('recursos/img/slider/bayusa_slider4.png')}}" class="img-responsive" alt="Bayusa Productos">
            <div class="carousel-caption">
              <h2></h2>
