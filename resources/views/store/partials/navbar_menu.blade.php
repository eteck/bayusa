<header>
  <div class="container-fluid header-deving">
    <div class="row">
      <img src="{{ asset('recursos/img/pleca-bayusa-green.png') }}" style="max-height: 100px;" class="img-responsive">
    </div>
  </div>
      ...
      <div class="container-fluid">
          ...
          <div ng-controller="MenuController" class="collapse navbar-collapse" id="app-navbar-collapse" aria-expanded="false" style="height: 1px;">
              ...
              <ul class="nav navbar-nav">
                ...
                <li>
                  <a href="{{ asset('files/catalogo.pdf') }}"><i class="fa fa-star"></i> <spam class="hidden-sm hidden-md">CATALOGO</spam></a>
                </li>                
